...
public class CadastroMedicoFrame extends JFrame{
	...
	public CadastroMedicoFrame() {
        ...
        JTextField especialidade = new JTextField(50);
        panel.add( especialidade );
        panel.add( new JLabel("CRM") );
        JTextField CRM = new JTextField(50);
        panel.add( CRM );
        
        principal.add(panel);
        
        JButton CadastrarCliente = new JButton("Cadastrar Médico");
        CadastrarCliente.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(null, "Médico Salvo!", null, 1);
					
					CadastroMedicoFrame.this.dispose();
